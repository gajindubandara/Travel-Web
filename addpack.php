        ...
        <div class="row justify-content-md-center ">
            <div class="col-md-8 ">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        Description:
                        <textarea class="form-control" name="txtDes" cols="30" rows="5"
                                  placeholder="Brief description about the tour " required></textarea>
                    </div>
                    <div class="form-group">
                        Accommodation:
                        <textarea class="form-control" name="txtAcc" cols="30" rows="5" placeholder="Ex-City Hotel"
                                  required></textarea>
                    </div>
                    <div class="form-group">
                        Food:
                        <textarea class="form-control" name="txtFood" cols="30" rows="5" placeholder="Ex-Buffet"
                                  required></textarea>
                    </div>
                    <div class="form-group">
                        Transport Method:
                        <textarea class="form-control" name="txtTrans" cols="30" rows="5" placeholder="Ex-Tourist Bus"
                                  required></textarea>
                    </div>
                    <div class="form-group">
                        Price:
                    ...
                    <div class="form-group">
                        Time Duration:
                        <input type="text" class="form-control" name="txtTime" placeholder="Ex- 2 Days 1 Night"
                               required>
                    </div>
